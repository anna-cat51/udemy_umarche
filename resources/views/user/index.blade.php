    ...
    <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                <form method="get" action="{{ route('user.items.index') }}">
                    <div class="lg:flex lg:justify-around">
                        <div class="lg:flex items-center">
                            ...
                            <div class="flex space-x-2 items-center">
                                ...
                                <div><button class="ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">検索する</button></div>
                            </div>
                        </div>
                    <div class="flex">
                    <div>
                    ...
                    <div>
                        <span clsss="text-sm">表示件数</span><br>
