                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="md:px-4 py-3">
                                  <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id])}}'" class="text-white bg-yellow-400 border-0 py-2 px-4 focus:outline-none hover:bg-yellow-600 rounded">編集</button>
                                </td>
